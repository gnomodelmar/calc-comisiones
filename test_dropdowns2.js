...
(async () => {
    ...
    // Select Medio de Pago so it doesn't fail HTML5 validation
    await page.selectOption('select >> nth=1', 'Tarjeta de Crédito');
    ...
    await page.screenshot({ path: 'config_saved_timestamp2.png', fullPage: true });
